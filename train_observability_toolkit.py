...
def explain_near_zero_gradients(layer_index: int,
                                gradients: GradientHistoryCallback,
                                activity: ActivityHistoryCallback,
                                variables: VariableHistoryCallback,
    ...
    variable_indices_lookup = variable_indices_by_layer(model, include_trainable_only=True)
    variable_indices = variable_indices_by_layer(model, include_trainable_only=True)[layer_index]
